...
export default function MaterialesPage() {
  ...
  const hasta = totalElements > 0 ? page * PAGE_SIZE + materiales.length : 0;
    ...
    <>
      ...
      {mostrarVacio ? (
        ...
        <div className="materiales-page-shell">
          ...
          {totalElements > 0 && (
            <div className="materiales-pagination-panel">
              <div className="materiales-pagination-summary">
                {hayFiltrosActivos
                  ? `Mostrando ${materialesFiltrados.length} coincidencias en esta pagina`
                  : `Mostrando ${desde} a ${hasta} de ${totalElements} materiales`}
              </div>

              <nav aria-label="Paginacion de materiales">
