...
export default function EntradasPage() {
  ...
  const entradasFiltradas = useMemo(() => {
    ...
    return entradas.filter((entrada) => {
      ...
      const coincideEstado = filtroEstado === "TODOS" || entrada.estado === filtroEstado;
              ...
              <tbody>
                {entradasFiltradas.length > 0 ? entradasFiltradas.map((entrada) => (
                  <tr key={entrada.id}>
                    ...
                    <td>
                      <span className={`badge bg-${colorEstado(entrada.estado)}-subtle text-${colorEstado(entrada.estado)} border border-${colorEstado(entrada.estado)}-subtle`}>
                        {entrada.estado}
                      </span>
                    </td>
                    ...
                    <td className="text-end">
                      <button
                        ...
                        disabled={entrada.estado === "CANCELADA" || entrada.estado === "RECIBIDA"}
